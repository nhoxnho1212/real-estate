            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('rooms')}>
                  Rooms <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('price')}>
                  Price <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('floorSpace')}>
                  Floor Space <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('attachment')}>
                  Attachment <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  Home Type <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {projectList.map((project, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{project.rooms}</td>
                  <td>{project.price}</td>
                  <td>{project.floorSpace}</td>
                  <td>{project.attachment}</td>
                  <td>{project.homeType ? <Link to={`home-type/${project.homeType.id}`}>{project.homeType.id}</Link> : ''}</td>
