...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './home-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HOMETYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_HOMETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HOMETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HOMETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HOMETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HOMETYPE actions', async () => {
      const expectedActions = [
        {
